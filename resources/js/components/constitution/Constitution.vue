              ...
              <tab-content title="Project Names" :selected="true">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label
                        >Project Name FiberNet / ชื่อโครงการของไฟเบอเน็ต</label
                      >
                      <br />
                      <label class="radio-inline">
                        <input
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label
                        >Project Name TXRX / ชื่อโครงการของทีเอ็กอาเอ็ก</label
                      >
                      <br />
                      <label class="radio-inline">
                        <input
                      ...
                      <input
                        ...
                        type="text"
                        class="form-control"
                        placeholder="ชื่อโครงการของทีเอ็กอาเอ็ก"
                        :class="{
                          'is-invalid': form.errors.has('projectNameTxrt'),
                        }"
                      />
                    </div>
                  </div>

                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('dateFn'),
                        }"
                      />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('dateTot'),
                        }"
                      />
                      <has-error :form="form" field="dateTot"></has-error>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('dateAis'),
                        }"
                      />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('date3BB'),
                        }"
                      />

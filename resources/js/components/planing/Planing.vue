        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" v-show="!editmode">Create New Planing</h5>
            ...
            <form
              @submit.prevent="editmode ? updatePlaning() : createPlaning()"
            >
              <div class="modal-body">
                <div class="row">
                  ...
                  <div :class="[editmode ? 'col-sm-2' : 'col-sm-3']">
                    <div class="form-group">
                      <label>Tel</label>
                      <input
                        v-model="form.tel"
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('isp'),
                        }"
                      >
                        <option disabled value="">เลือก isp</option>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('agent'),
                        }"
                      />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('technicianPlaning'),
                        }"
                      />
                      <has-error
                        :form="form"
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      >
                        <option disabled value="">เลือก ID Required</option>
                        <option value="AIS">AIS</option>
                        <option value="TRUE">TRUE</option>
                        <option value="3BB">3BB</option>
                        <option value="TOT">TOT</option>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      >
                        <option disabled value="">เลือก status</option>
                        <option value="สำเร็จ">สำเร็จ</option>
                        <option value="ลูกค้าเลื่อนหน้างาน">
                          ลูกค้าเลื่อนหน้างาน
                        </option>
                        <option value="นิติฯไม่อนุญาต">นิติฯไม่อนุญาต</option>
                        <option value="ติดปัญหาหน้างาน">ติดปัญหาหน้างาน</option>
                        <option value="อื่นๆ โปรดระบุในรีมาร์ค">
    ...
    var table = $(this.$refs.planing).DataTable({
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function (e, dt, node, config) {
            dt.column(17).search("FINET").draw();
          },
        },
        {

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ translate("operatingtime.header") }}
                            </h3>
                            <div class="card-tools">
                                ...
                                >
                                    ...
                                    {{ translate("operatingtime.addnew") }}
                                </button>
                            </div>
                        </div>
                        <!-- /.card-header -->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" v-show="!editmode">
                                {{ translate("operatingtime.create.header") }}
                            </h5>
                            <h5 class="modal-title" v-show="editmode">
                                {{ translate("operatingtime.update.header") }}
                            </h5>
                            <button
                                type="button"
                                class="close"
                        ...
                        >
                            ...
                            <div class="modal-footer">
                                <button
                                    ...
                                    data-dismiss="modal"
                                >
                                    {{ translate("operatingtime.actions.close") }}
                                </button>
                                <button
                                    v-show="editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("operatingtime.actions.update") }}
                                </button>
                                <button
                                    v-show="!editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("operatingtime.actions.create") }}
                                </button>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            Swal.fire({
                title: window.translate("operatingtime.alert.delete_building_title"),
                text:
                    window.translate("operatingtime.alert.delete_building_text") +
                    ` [${item.worktime}]`,
                showCancelButton: true,
                confirmButtonColor: "#d33",
                cancelButtonColor: "#3085d6",
                cancelButtonText: window.translate(
                    "operatingtime.alert.delete_building_cancel_button_text"
                ),
                confirmButtonText: window.translate(
                    "operatingtime.alert.delete_building_confirm_button_text"
                )
            }).then(result => {
                ...
                if (result.value) {
                    this.form
                        ...
                        .then(() => {
                            Swal.fire(
                                window.translate(
                                    "operatingtime.alert.comfirm_delete_title"
                                ),
                                window.translate(
                                    "operatingtime.alert.confirm_delete_message"
                                ),
                                "success"
                            );
                            // Fire.$emit('AfterCreate');

                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" v-show="!editmode">
                                {{ translate("contractsell.create.header") }}
                            </h5>
                            <h5 class="modal-title" v-show="editmode">
                                {{ translate("contractsell.update.header") }}
                            </h5>
                            <button
                                type="button"
                                class="close"
                        ...
                        >
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                v-model="form.nameSale"
                                                type="text"
                                                class="form-control"
                                                placeholder="Enter your name sale..."
                                                :class="{
                            ...
                            <div class="modal-footer">
                                <button
                                    ...
                                    data-dismiss="modal"
                                >
                                    {{ translate("contractsell.actions.close") }}
                                </button>
                                <button
                                    v-show="editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("contractsell.actions.update") }}
                                </button>
                                <button
                                    v-show="!editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("contractsell.actions.create") }}
                                </button>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            Swal.fire({
                title: window.translate("contractsell.alert.delete_building_title"),
                text:
                    window.translate("contractsell.alert.delete_building_text") +
                    ` [${item.area3BB}]`,
                showCancelButton: true,
                confirmButtonColor: "#d33",
                cancelButtonColor: "#3085d6",
                cancelButtonText: window.translate(
                    "contractsell.alert.delete_building_cancel_button_text"
                ),
                confirmButtonText: window.translate(
                    "contractsell.alert.delete_building_confirm_button_text"
                )
            }).then(result => {
                // Send request to the server
                if (result.value) {
                    this.form
                        .delete("/salefm/" + item.id)
                        .then(() => {
                            Swal.fire(
                                window.translate(
                                    "contractsell.alert.comfirm_delete_title"
                                ),
                                window.translate(
                                    "contractsell.alert.confirm_delete_message"
                                ),
                                "success"
                            );
                            // Fire.$emit('AfterCreate');

                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                v-model="form.zoneTel"
                                                type="text"
                                                class="form-control"
                                                placeholder="Enter your tel zone..."
                                                :class="{
                                                    'is-invalid': form.errors.has(
                                                        'zoneTel'
                                                    )
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            Swal.fire({
                title: window.translate("zone.alert.delete_building_title"),
                text:
                    window.translate("zone.alert.delete_building_text") +
                    ` [${item.zone}]`,
                showCancelButton: true,
                confirmButtonColor: "#d33",
                cancelButtonColor: "#3085d6",
                cancelButtonText: window.translate(
                    "zone.alert.delete_building_cancel_button_text"
                ),
                confirmButtonText: window.translate(
                    "zone.alert.delete_building_confirm_button_text"
                )
            }).then(result => {
                ...
                if (result.value) {
                    this.form
                        ...
                        .then(() => {
                            Swal.fire(
                                window.translate(
                                    "zone.alert.comfirm_delete_title"
                                ),
                                window.translate(
                                    "zone.alert.confirm_delete_message"
                                ),
                                "success"
                            );
                            // Fire.$emit('AfterCreate');

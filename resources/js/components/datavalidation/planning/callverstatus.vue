                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ translate("callverstatus.header") }}
                            </h3>
                            <div class="card-tools">
                                ...
                                >
                                    ...
                                    {{ translate("callverstatus.addnew") }}
                                </button>
                            </div>
                        </div>
                        <!-- /.card-header -->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" v-show="!editmode">
                                {{ translate("callverstatus.create.header") }}
                            </h5>
                            <h5 class="modal-title" v-show="editmode">
                                {{ translate("callverstatus.update.header") }}
                            </h5>
                            <button
                                type="button"
                                class="close"
                        ...
                        >
                            ...
                            <div class="modal-footer">
                                <button
                                    ...
                                    data-dismiss="modal"
                                >
                                    {{ translate("callverstatus.actions.close") }}
                                </button>
                                <button
                                    v-show="editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("callverstatus.actions.update") }}
                                </button>
                                <button
                                    v-show="!editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("callverstatus.actions.create") }}
                                </button>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            Swal.fire({
                title: window.translate("callverstatus.alert.delete_building_title"),
                text:
                    window.translate("callverstatus.alert.delete_building_text") +
                    ` [${item.callVerStatus}]`,
                showCancelButton: true,
                confirmButtonColor: "#d33",
                cancelButtonColor: "#3085d6",
                cancelButtonText: window.translate(
                    "callverstatus.alert.delete_building_cancel_button_text"
                ),
                confirmButtonText: window.translate(
                    "callverstatus.alert.delete_building_confirm_button_text"
                )
            }).then(result => {
                ...
                if (result.value) {
                    this.form
                        ...
                        .then(() => {
                            Swal.fire(
                                window.translate(
                                    "callverstatus.alert.comfirm_delete_title"
                                ),
                                window.translate(
                                    "callverstatus.alert.confirm_delete_message"
                                ),
                                "success"
                            );
                            // Fire.$emit('AfterCreate');

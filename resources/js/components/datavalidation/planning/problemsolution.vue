                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ translate("problemsolution.header") }}
                            </h3>
                            <div class="card-tools">
                                ...
                                >
                                    ...
                                    {{ translate("problemsolution.addnew") }}
                                </button>
                            </div>
                        </div>
                        <!-- /.card-header -->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" v-show="!editmode">
                                {{ translate("problemsolution.create.header") }}
                            </h5>
                            <h5 class="modal-title" v-show="editmode">
                                {{ translate("problemsolution.update.header") }}
                            </h5>
                            <button
                                type="button"
                                class="close"
                        ...
                        >
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                class="form-control"
                                                placeholder="Enter your name area problemsolution..."
                                                :class="{
                            ...
                            <div class="modal-footer">
                                <button
                                    ...
                                    data-dismiss="modal"
                                >
                                    {{ translate("problemsolution.actions.close") }}
                                </button>
                                <button
                                    v-show="editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("problemsolution.actions.update") }}
                                </button>
                                <button
                                    v-show="!editmode"
                                    type="submit"
                                ...
                                >
                                    {{ translate("problemsolution.actions.create") }}
                                </button>
                            </div>
                        </form>
                    </div>
...
export default {
    ...
    methods: {
        ...
        updateItem() {
            ...
            this.form
                .put("/problemsolution/" + this.form.id)
                .then(response => {
                    // success
                    $("#addNew").modal("hide");
                    Toast.fire({
        ...
        deleteItem(item) {
            Swal.fire({
                title: window.translate("problemsolution.alert.delete_building_title"),
                text:
                    window.translate("problemsolution.alert.delete_building_text") +
                    ` [${item.problemSolution}]`,
                showCancelButton: true,
                confirmButtonColor: "#d33",
                cancelButtonColor: "#3085d6",
                cancelButtonText: window.translate(
                    "problemsolution.alert.delete_building_cancel_button_text"
                ),
                confirmButtonText: window.translate(
                    "problemsolution.alert.delete_building_confirm_button_text"
                )
            }).then(result => {
                // Send request to the server
                if (result.value) {
                    this.form
                        .delete("/problemsolution/" + item.id)
                        .then(() => {
                            Swal.fire(
                                window.translate(
                                    "problemsolution.alert.comfirm_delete_title"
                                ),
                                window.translate(
                                    "problemsolution.alert.confirm_delete_message"
                                ),
                                "success"
                            );
                            // Fire.$emit('AfterCreate');

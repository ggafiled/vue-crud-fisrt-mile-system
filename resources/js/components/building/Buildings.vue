      ...
      >
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            ...
            <form
              @submit.prevent="editmode ? updateBuilding() : createBuilding()"
            >
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('fmCode'),
                        }"
                      />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('roomSum'),
                        }"
                      />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('districtName'),
                        }"
                      />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('countyName'),
                        }"
                      />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('provinceName'),
                        }"
                      />
                      <has-error :form="form" field="provinceName"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('postalCode'),
                        }"
                      />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('contractSell'),
                        }"
                      />
                      <has-error :form="form" field="contractSell"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('contractDate'),
                        }"
                      />
                      <has-error :form="form" field="contractDate"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        placeholder="Enter your contract date..."
                        :class="{
                          'is-invalid': form.errors.has('contractDateEnd'),
                        }"
                      />
                      <has-error
                        :form="form"
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('spendSpace'),
                        }"
                      >
                        <option disabled value="">เลือกรูปแบบการชำระ</option>
                        <option value="ไม่แบ่งรายได้">ไม่แบ่งรายได้</option>
                        <option value="แบ่งรายได้ทุกเดือน">
                          แบ่งรายได้ทุกเดือน
                        </option>
                        <option value="ชำระรายปี">ชำระรายปี</option>
                        <option value="ชำระรายปีแล้วแบ่งรายได้">
                          ชำระรายปีแล้วแบ่งรายได้
                        </option>
                        <option value="ชำระรายปีแบบขั้นบันได">
                      ...
                      <has-error :form="form" field="spendSpace"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('condition'),
                        }"
                      />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('contractPeriod'),
                        }"
                      />
                      <has-error
                        :form="form"
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('areaN'),
                        }"
                      />
                      <has-error :form="form" field="areaN"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('bbN'),
                        }"
                      />
                      <has-error :form="form" field="bbN"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('area3BB'),
                        }"
                      >
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('areaTrue'),
                        }"
                      >
                        <option disabled value="">เลือกพื้นที่</option>
                        <option value="BMA 1 (North West)">
                          BMA 1 (North West)
                        </option>
                        <option value="BMA 2 (South West)">
                          BMA 2 (South West)
                        </option>
                        <option value="BMA 3 (North East)">
                          BMA 3 (North East)
                        </option>
                        <option value="BMA 4 (South East)">
                          BMA 4 (South East)
                        </option>
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        placeholder="Enter your area Tr..."
                        :class="{
                          'is-invalid': form.errors.has('areaTrueNew'),
                        }"
                      >
                        <option disabled value="">เลือกพื้นที่</option>
                        <option value="BMA 1 (North West)">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('areaAis'),
                        }"
                      >
                        <option disabled value="">เลือกพื้นที่</option>
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('areaFiberNet'),
                        }"
                      >
                        <option disabled value="">เลือกพื้นที่</option>
                        <option value="Yes">Yes</option>
                      ...
                      <has-error :form="form" field="areaFiberNet"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <select
                        ...
                        :class="{
                          'is-invalid': form.errors.has('operatingTime'),
                        }"
                      >
                        <option disabled value="">
                          เลือกเวลาในการปฏิบัติงาน
                        </option>
                        <option value="จันทร์ - ศุกร์ (9.00 - 17.00 น)">
                          จันทร์ - ศุกร์ (9.00 - 17.00 น)
                        </option>
                        <option value="จันทร์ - เสาร์ (9.00 - 17.00 น)">
                          จันทร์ - เสาร์ (9.00 - 17.00 น)
                        </option>
                        <option value="จันทร์ - ศุกร์ และเสาร์ครึ่งวันช่วงเช้า">
                          จันทร์ - ศุกร์ และเสาร์ครึ่งวันช่วงเช้า
                        </option>
                        <option value="จันทร์ - ศุกร์ และเสาร์ครึ่งวันช่วงบ่าย">
                          จันทร์ - ศุกร์ และเสาร์ครึ่งวันช่วงบ่าย
                        </option>
                        <option
                          value="จันทร์ - ศุกร์ และวันเสาร์ ประสาน นิติฯ ก่อน"
                        >
                          จันทร์ - ศุกร์ และวันเสาร์ ประสาน นิติฯ ก่อน
                        </option>
                        <option
                          value="จันทร์ - ศุกร์ และวันเสาร์-อาทิตย์ ประสาน นิติฯ ก่อน"
                        >
                          จันทร์ - ศุกร์ และวันเสาร์-อาทิตย์ ประสาน นิติฯ ก่อน
                        </option>
                        <option value="ทุกวัน">ทุกวัน</option>
                      </select>
                      <has-error :form="form" field="operatingTime"></has-error>
                    </div>
                  </div>
                </div>
              </div>
  ...
  mounted() {
    ...
    var table = $(this.$refs.buildings).DataTable({
      ...
      buttons: [
        ...
        {
          text: "<i class='bi bi-list-check mr-1'></i>แสดงที่เลือกไว้",
          action: function (e, dt, node, config) {

                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input
                                                    ...
                                                    type="text"
                                                    class="form-control"
                                                    placeholder="Enter your contractTerm..."
                                                    :class="{
                                                        'is-invalid': form.errors.has(
                                                            'contractTerm'
                                                        )

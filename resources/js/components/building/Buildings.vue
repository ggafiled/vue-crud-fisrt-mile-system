                ...
                <div class="row">
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="form.contractSell">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>*</label>
                      <select class="form-control" v-model="form.spendSpace">
                        <option value="">Select a Class</option>
                        <option
                          :value="item.id"
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': form.errors.has('reNewContact'),
                        }"
                      />
                      <has-error :form="form" field="reNewContact"></has-error>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="form.area3BB">
                        <option value="">Select a Class</option>
                        <option
                          :value="item.id"
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="form.areaTrue">
                        <option value="">Select a Class</option>
                        <option
                          :value="item.id"
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="form.areaAis">
                        <option value="">Select a Class</option>
                        <option
                          :value="item.id"
                ...
                <div class="row">
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="form.areaFiberNet">
                        <option value="">Select a Class</option>
                        <option
                          :value="item.id"
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" v-model="form.operatingTime">
                        <option value="">Select a Class</option>
                        <option
                          :value="item.id"

                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            {{ translate("building.fibernet.header") }}
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
    ...
    mounted() {
        ...
        var table = $(this.$refs.buildinglist).DataTable({
            ...
            columns: [
                ...
                {
                    data: "progress.sinet_progress.status", // EDIT
                    render: function(data, type, row, meta) {
                        if (!data) {
                            return "ไม่ได้ระบุ";
                        } else {

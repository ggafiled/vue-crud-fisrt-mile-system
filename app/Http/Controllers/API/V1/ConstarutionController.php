    ...
    public function store(ConstarutionRequest $request)
    {
        try {
            $constarution = new Constarution([
                ...
                'ifccStatus_id' => $request->input('ifccStatus_id'),
                'wallboxType' => $request->input('wallboxType'),
                'microductStatus_id' => $request->input('microductStatus_id'),
                'fiberMicroductType' => $request->input('fiberMicroductType'),
                'fiberMicroduct1' => $request->input('fiberMicroduct1'),
                'fiberMicroduct2' => $request->input('fiberMicroduct2'),
                'fiberMicroductSize' => $request->input('fiberMicroductSize'),
                'fiberMicroductFloor' => $request->input('fiberMicroductFloor'),
                'fiberBlowStatus_id' => $request->input('fiberBlowStatus_id'),
                'fiberConvertionalType' => $request->input('fiberConvertionalType'),
                'fiberConvertionalFloor' => $request->input('fiberConvertionalFloor'),
                'fiberVertically' => $request->input('fiberVertically'),
                'fiberVerticallyType' => $request->input('fiberVerticallyType'),
                'fiberBuildingStatus' => $request->input('fiberBuildingStatus'),
                'blow' => $request->input('blow'),
                'spliceStatus_id' => $request->input('spliceStatus_id'),

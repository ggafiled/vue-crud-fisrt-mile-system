...
class ConstarutionRequest extends FormRequest
{
    ...
    public function createRules(): array
    {
        return [
            ...
            'projectNameTxrt' => "string|max:191",
            ...
            'microductSize' => "sometimes|required_if:microductType,FiberBlow|nullable|string|max:191",
            'microductFloor' => "sometimes|required_if:microductType,FiberBlow|nullable|string|max:191",
            'blowStatus' => "sometimes|required_if:microductType,FiberBlow|nullable|string|max:191",
            'blowCore' => "sometimes|required_if:microductType,FiberBlow|nullable|string|max:191",
            'convertionalType' => "sometimes|required_if:microductType,FiberConvertional|nullable|string|max:191",
            'convertionalFloor' => "sometimes|required_if:microductType,FiberConvertional|nullable|string|max:191",
            'vertically' => "sometimes|required_if:microductType,FiberConvertional|nullable|string|max:191",
            'verticallyType' => "sometimes|required_if:microductType,FiberConvertional|nullable|string|max:191",
            'buildingStatus' => "sometimes|required_if:microductType,FiberConvertional|nullable|string|max:191",
